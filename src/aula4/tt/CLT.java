...
public abstract class CLT {
    ...
    public CLT(BigDecimal salarioBase, Double horasSemanais, Double fimDeSemana, Double bonificacao, Integer metaAtingida) {
    ...
    public void pagarSalario() {
        ...
        System.out.println("Salário base: R$" + String.format("%.2f", this.salarioBase.doubleValue()) + "\nValor a receber: R$ " + String.format("%.2f", total.doubleValue()));
    }
}
